...
const projects = [
  {
    title: "NeuralChat",
    desc: "Real-time AI chat platform with streaming responses, multi-model support, and collaborative workspaces. Built for teams who need intelligent conversations at scale.",
  ...
  {
    title: "CloudForge",
    desc: "Infrastructure-as-code dashboard for managing multi-cloud deployments with visual topology mapping. One dashboard to rule them all.",
  ...
  {
    title: "DataLens",
    desc: "Analytics platform with real-time data visualization, custom dashboards, and automated reporting. Transform raw data into actionable insights.",
